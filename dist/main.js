...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fullcalendar/core'), require('moment')) :
    typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core', 'moment'], factory) :
    (global = global || self, factory(global.FullCalendarYearView = {}, global.FullCalendar, global.moment));
    ...
    var YearTile =  (function (_super) {
        ...
        YearTile.prototype._renderFrame = function (date) {
            ...
            var title = dateEnv.format(date, core.createFormatter(options.dayPopoverFormat)
            );
            this.el.innerHTML =
    ...
    var YearGrid =  (function (_super) {
        ...
        YearGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            if (this.renderProps.cellWeekNumbersVisible && (date.getUTCDay() === weekCalcFirstDow)) {
                html += core.buildGotoAnchorHtml(options, dateEnv, { date: date, type: 'week' }, { 'class': 'fc-week-number' }, dateEnv.format(date, WEEK_NUM_FORMAT)
                );
            }
            if (isDayNumberVisible) {
                html += core.buildGotoAnchorHtml(options, dateEnv, date, { 'class': 'fc-day-number' }, '<span class="fc-day-number-weekday">' + moment(date).format('dd') + '</span>' + dateEnv.format(date, DAY_NUM_FORMAT)
                );
            }
            html += '</td>';
            return html;
    ...
    var AbstractYearView =  (function (_super) {
        ...
        AbstractYearView.prototype._renderSkeleton = function (context) {
            ...
            this.scroller = new core.ScrollComponent('hidden',
            'auto'
            );
    ...
    exports.AbstractDayGridView = AbstractYearView;
    exports.DayBgRow = YearDayBgRow;
    exports.DayGrid = YearGrid;
    exports.DayGridSlicer = DayGridSlicer;
    exports.DayGridView = YearGridView;
    exports.SimpleDayGrid = SimpleYearGrid;
